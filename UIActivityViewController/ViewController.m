...
- (IBAction)shareBtnClicked:(id)sender {
    ...
    //自定义Activity
    customActivity * custom = [[customActivity alloc] initWithTitie:@"且行且珍惜_iOS" withActivityImage:[UIImage imageNamed:@"wang"] withUrl:nil withType:UIActivityTypePostToWeibo withShareContext:activityItems];
    ...
    //关闭系统的一些activity类型
    activityVC.excludedActivityTypes = @[UIActivityTypePrint,UIActivityTypeCopyToPasteboard,UIActivityTypeAssignToContact,UIActivityTypeSaveToCameraRoll,UIActivityTypeAddToReadingList,UIActivityTypePostToWeibo];
